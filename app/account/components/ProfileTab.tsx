...
const tabStyle = "whitespace-nowrap px-2 py-1 h-12 font-bold ui-selected:rounded-md ui-selected:px-4 ui-selected:bg-slate-800 ui-selected:text-indigo-800 text-white";
        ...
        <section className="block pt-8 space-y-24 w-full">
            <Tab.Group>
                <Tab.List className="w-full flex items-center justify-between py-1 px-12 rounded-full bg-slate-900 h-16">
                    ...
                    <Tab className={tabStyle}>KYC</Tab>
                </Tab.List>
